...
const GroupAbout = () => {
  return (
    <div className=" px-[75px] py-[120px] ">
      <div className="bg-grpupCover bg-cover h-[500px] w-full flex items-end">
        <div className="bg-[rgb(237,237,237,0.9)] backdrop-blur-md space-y-4 w-[490px] px-9 py-5 rounded-tr-xl">
          <p>
