...
const AboutGiga = () => {
  return (
    <div className="bg-white/70 bg-red-600 backdrop-blur-[200px] relative overflow-hidden py-28 px-4">
      <div className="bg-secondary h-60 -mt-60 mx-auto md:ml-96 blur-[200px] w-60 rounded-full absolute z-0"></div>

      <motion.div
        className="flex flex-col md:flex-row container xl:px-8 px-2 mx-auto items-center justify-between relative z-10"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      >
        ...
        <div className="flex md:flex-row px-6 flex-col md:items-center md:gap-6 mt-12 md:mt-0">
          <div className="flex flex-col items-center space-y-4">
            ...
            >
              <Image src={giga1} alt="Giga Group Image 1" layout="fill" objectFit="cover" />
            </motion.div>
            ...
            >
              <Image src={giga2} alt="Giga Group Image 2" layout="fill" objectFit="cover" />
            </motion.div>
          </div>
          ...
          <div className="flex flex-col my-8 md:my-0 items-center space-y-4">
            ...
            >
              <Image src={giga3} alt="Giga Group Image 3" layout="fill" objectFit="cover" />
            </motion.div>
            ...
            >
              <Image src={giga4} alt="Giga Group Image 4" layout="fill" objectFit="cover" />
            </motion.div>
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <Image src={giga5} alt="Giga Group Image 5" layout="fill" objectFit="cover" />
            </motion.div>
          </div>
        </div>
      </motion.div>
