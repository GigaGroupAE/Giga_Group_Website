...
import CompaniHeroSection from "../components/companiesComponents/CompanHero";
      ...
      <div className="container xl:px-8 mx-auto">
        <div className="flex justify-between items-center py-16 px-6 md:px-0">
          <p className="font-poppins text-sm text-center">
            The Giga Group comprises several companies independently and jointly
            owned by the Giga family in Pakistan and the Middle East. The Giga
            Group has a multifarious set of business activities in textile, gold
            refining, bullion trade, real estate development, and the
